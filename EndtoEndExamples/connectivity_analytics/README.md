...
3. Click <img src="/EndtoEndExamples/connectivity_analytics/img/output-schema-icon.png" alt="output schema" width=3% height=auto>. Notice the following fields:
...
2. Click <img src="/EndtoEndExamples/connectivity_analytics/img/output-schema-icon.png" alt="output schema" width=3% height=auto>. Notice the following fields:
...
2. Click <img src="/EndtoEndExamples/connectivity_analytics/img/output-schema-icon.png" alt="output schema" width=3% height=auto>. These fields are used to visualize the synthetic data distribution:
    - `latency_ms`
    - `jitter_ms`
    - `signal_strength`  
